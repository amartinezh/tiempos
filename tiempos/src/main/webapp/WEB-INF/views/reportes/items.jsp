										...
										<table id="dt_basic" class="table table-striped table-bordered" width="100%">
											...
											<tbody>
												<c:forEach items="${flash1ist}" var="Flashh" varStatus="loopCounter">														
													<tr>
														<td>
															<a href=""><c:out value="${Flashh.coprod}" /></a>														
														</td>
														<td>
															<a href=""><c:out value="${Flashh.codesb}" /></a>														
														</td>
														<td>
														...
														<td>
															<c:choose>
																<c:when test="${Flashh.clqty > 0}">
																	<fmt:formatNumber type="currency" value="${Flashh.clnet/Flashh.clqty}" />
																</c:when>
																<c:otherwise>
																	<fmt:formatNumber type="currency" value="${Flashh.clqty}" />
																</c:otherwise>
															</c:choose>
														</td>												
													</tr>
