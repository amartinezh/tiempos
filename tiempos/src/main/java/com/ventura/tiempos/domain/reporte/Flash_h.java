...
@Table(name="flash_pnh", schema="public")
public class Flash_h implements Serializable{
	...
	public Flash_h(String cozon, String codzbp, BigDecimal ckqty, BigDecimal cpqty, BigDecimal clord, BigDecimal cldev, BigDecimal clnet, BigDecimal cpdte, BigDecimal clqty, BigDecimal clqtyb, BigDecimal clnetb, BigDecimal clnetc, String codesz) {
		this.cozon = cozon;
		this.codzbp = codzbp;
		this.ckqty = ckqty;
		this.cpqty = cpqty;
	...
	public Flash_h(String cozon, String codzbp, BigDecimal ckqty, BigDecimal cpqty, BigDecimal clord, BigDecimal cldev, BigDecimal clnet, BigDecimal cpdte, BigDecimal clqty) {
		this.cozon = cozon;
		this.codzbp = codzbp;
		this.ckqty = ckqty;
		this.cpqty = cpqty;
